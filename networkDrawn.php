...
// Generate the code of the digraph in the DOT language
// and store the phylogenetic network as an array, $digraph, associating to each vertex an array of its children
// and compute the indegree for each node, stored in the $inDegree array
